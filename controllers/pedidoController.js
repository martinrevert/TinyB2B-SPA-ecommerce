...
angular.module('app').controller('pedidoCtrl', function ($scope, productosSrv, notadeventaSrv, marcasSrv, usSpinnerService) {
    ...
    $scope.buscarporcategorias = function () {
        ...
        //Aqui va modelo lógico para apagar o encender exhibición de marcas vs productos
